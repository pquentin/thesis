...
% TODO n'indiquer que les différences par rapport à ch:srl
...
La méthode est très proche de celle présentée au Chapitre~\ref{srl}, et
implémentée dans le dossier \texttt{src/domain} de
...
Il nous suffit d'utiliser l'association que nous avons produit entre les rôles
considérés par ces ressources et les rôles VerbNet avant d'évaluer la
