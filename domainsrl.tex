...
compréhension située (\textit{situated understanding} en anglais). L'objectif est
...
système n'a pas besoin de distinguer les arguments jouant un rôle (\textit{core}
dans FrameNet) des autres (\textit{non-core}), ce qui est une part importante de
