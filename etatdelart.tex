...
Chaque sélecteur syntaxique suit le même principe que le sélecteur par
...
En effet, \cite{sun2010investigating} ont utilisé un large lexique de cadres de
...
\textit{Co-Patient}, \textit{Co-Theme}, \textit{Location},
\textit{Destination}, \textit{Source}, \textit{Experiencer}, \textit{Extent},
\textit{Instrument}, \textit{Material}, \textit{Product}, \textit{Patient},
\textit{Predicate}, \textit{Recipient}, \textit{Stimulus}, \textit{Theme},
\textit{Time} et \textit{Topic}.
