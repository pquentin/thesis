...
en particulier la trop grande finesse de distinction des sens, étaient
suffisamment importants pour nécessiter une alternative avec des sens
...
l'ordre de 70\%), et qu'utiliser un autre inventaire est un moyen efficace de
...
Ces modèles de langues permettent aussi d'obtenir des mesures de similarité
sémantiques utiles. L'utilisation des modèles de langue pour l'étude de la
similarité entre deux mots provient de l'hypothèse distributionnelle
...
% TODO phrase coupée
% TODO être clair sur lexèmes/mots
...
% TODO Google n'a pas estimé de n-grammes : compte, pas fréquence ni masse de probabilité, n'est-ce pas ?
...
taille du vocabulaire et $N$ la taille du contexte étudié. En considérant
...
utilisé un corpus de livres de $10^{12}$ mots pour estimer ses n-grammes
