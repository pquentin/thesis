...
si la disponibilité de corpus de plus d'un milliard de mots (\emph{giga-word})
rend possible des résultats plus fins \citep{kawahara2014step}.
...
Depuis la diffusion de word2vec \citep{mikolov2013distributed} et de ses bons
...
L'annotation des rôles VerbNet est effectuée grâce au niveau de la syntaxe, CCG
...
danois et l'appliquent à un corpus suédois, et montrent qu'il faut 1500 phrases
annotées pour qu'un modèle entraîné directement sur le corpus suédois soit
meilleur. \citep{kozhevnikov2013cross} montrent sur trois paires de langues
(Anglais-Chinois, Anglais-Tchèque et Anglais-Français) que les résultats sont
meilleurs en modifiant le modèle appris qu'en projetant l'annotation comme au
