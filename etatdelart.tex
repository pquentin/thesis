...
%Nous commençerons par traiter la désambiguïsation lexicale, en présentant le
%problème puis les difficultés principales. Nous réitérerons avec l'annotation
%en rôles sémantiques, avant de citer les principales approches utilisées pour
%les deux tâches, dans le but d'identifier celles qui seraient semblables ou
%compatibles. Nous examinerons ensuite différentes méthodes d'évaluation
%permettant de comparer les performances de différentes méthodes. Nous verrons
%par la suite les spécificités du français pour les deux tâches considérées,
%puis identifierons finalement plusieurs pistes nous permettant d'aller au-delà
%du travail réalisé par \cite{mouton2011phd}.
...
Après avoir expliqué en quoi ces tests ne sont pas faciles à construire et ne
