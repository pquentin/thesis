...
étudier ces distributions de probabilité. On peut étudier deux types de
distributions différentes correspondant à deux types de relations entre les
mots \citep{sahlgren2008distributional} :
...
la relation de complément du nom, c'est le mot \textit{billet} modifie le plus
...
\citep{deerwester1990indexing} 

La manière la plus répandue pour faire cela est d'utiliser un réseau de
neurones peu profond dont une des couches sera le vecteur représentant chaque
mot. \cite{hinton1986learning} a d'abord proposé l'idée d'un réseau de neurones
pour représenter des concepts à l'aide de vecteurs faisant partie du réseau,
...
particulier, \cite{levy2014neural} montrent qu'une nouvelle mesure de
similarité obtient des résultats similaires à \cite{mikolov2013efficient}, ce
qui est un pas important vers une meilleure compréhension du comportement des
réseaux de neurones pour apprendre des représentations de mots.
