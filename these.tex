...
\publishers{
    Guy \textsc{Lapalme} \\
    Patrick \textsc{Saint-Dizier} \\
    Laurence \textsc{Danlos} \\
    Gaël \textsc{de Chalendar} \\
~\\
~\\
Commissariat à l'Énergie Atomique\\Université Paris Diderot}
...
climatique, Informatique et Internet, et le football. Nous montrons que la
ressource VerbNet traduite vers le français donne la possibilité d'annoter en
rôles sémantiques des textes aussi bien en domaine général qu'en domaine
spécifique.
