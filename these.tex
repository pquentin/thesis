...
\begin{itemize}
    ...
    \item Enfin, l'annotation en rôles sémantiques est capable d'opérer à
        ...
        VerbNet que nous suivons rend possible la classification de l'ensemble
        des verbes du «~domaine général~»\footnote{Cependant, nous nous
            limitons dans cette étude aux verbes, les autres parties du
        discours devant faire l'objet d'une autre étude}.
