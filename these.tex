...
Le seul sélecteur syntaxique utilisé pour les verbes, adjectifs et adverbes est
le sélecteur SimSyn.

Concernant les noms, la configuration change suivant la version de WoNeF. La
version haute précision utilise les sélecteurs MeroHoloLikeHyper et MeroHolo.
La version à haut F-score rajoute le sélecteur HyperHypo(COD\_V, HYPER). La
version à haute couverture rajoute elle les sélecteurs SimSyn,
HyperHypo(COMPDUNOM, HYPER), HyperHypo(SUJ\_V, HYPER) et HyperHypo(COMPDUNOM,
HYPO).
