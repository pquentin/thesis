...
MeroHolo, 6 HyperHypo(SUJ_V, HYPER), 7 HyperHypo(COMPDUNOM, HYPO), 8
HyperHypo(COD_V, HYPER), 9 HyperHypo(window10, HYPER)
verb :  1 LastChance, 2 SimSyn, 3 HyperHypo(SUJ_V_RELG, HYPER), 4
HyperHypo(COD_V.reverse, HYPER), 6 HyperHypo(CPL_V.reverse, HYPER), 6
HyperHypo(ATB_S.reverse, HYPER), 7 HyperHypo(SUJ_V.reverse, HYPER),
8(CPLV_V.reverse, HYPER)
