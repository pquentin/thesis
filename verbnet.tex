...
cas de :
\begin{itemize}
    \item \texttt{pit-10.7} formé avec des parties constitutives d'animaux ou
        d'objets avec des verbes tels que :
        \begin{itemize}
        ...
        \end{itemize}
    \item ou \texttt{weekend-56} formé à partir de verbes issus de noms
        décrivant une période de temps tels que :
        \begin{itemize}
...
Par contre, \texttt{debone-10.8} et ses verbes formés par le préfixe \emph{dé-}
plus un nominal (\emph{debark, debone}) a un équivalent français avec les
préfixes \emph{dé-} ou \emph{é} (\emph{déveiner}, \emph{équeuter}).
...
% TODO Noter quelque part que l'évaluation se fait manuellement
