...
Pour un certain nombre de chercheurs, c'est le moment de se tourner vers de
...
On peut alors déterminer que le livre est le thème sémantique pour la prédicat
