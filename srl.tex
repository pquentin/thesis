...
qu'elles sont complémentaires par rapport aux autres approches. En nous
inspirant de \citep{swier2004unsupervised,swier2005exploiting}, nous montrons
dans ce chapitre un système d'annotation en rôles sémantiques qui se veut
simple à mettre en place facile à reproduire. Dans ce système, la prise en
compte de la voix passive réduit le taux d'erreur de 15.7~\%. Ainsi, l'approche
facilite l'analyse des erreurs, n'a pas besoin d'un corpus annoté manuellement
et n'est a priori pas spécifique à un domaine en particulier.
...
sémantiques dans un cadre général en l'utilisant avec les frames définies par
FrameNet et en l'évaluant sur le corpus annoté en rôles sémantiques fourni par
FrameNet.
