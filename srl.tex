...
\citet{abend2008supervised,brown2011verbnet,kawahara2014single}. En effet, les
...
\begin{itemize}
    ...
    \item et l'apport de la représentation de mots (\emph{word embeddings})
...
\emph{elongated} ou \emph{nonrigid} qui sont des propriétés qu'on ne peut pas
...
Nous ne considérons par la suite uniquement les résultats de SEMAFOR avec
...
\citep[section~4]{das2014parsnig}, et ce n'est de toute façon que sur les
...
qui est la priorité pour nos travau futurs.
